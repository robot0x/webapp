$(function(){
    ...
    function handleTitle(titleArray){
        var ret = '';
        if(titleArray){
            var i = 0,l = titleArray.length;
            if(l === 1){
                ret = titleArray[0];
            }else{
               while(i < l){
        ...
        $.ajax({
            ...
            $.ajax({
                ...
                for(var i = 0,l = dataArray.length;i<l;i++){
                    ...
                    stringBuffer.push('<li data-index="',i,'"><a href="',changeURL(paddingData.url),'" target="_blank"><img src="',paddingData.banner,'" alt="" width="490" height="317"><div><p>',handleTitle(paddingData.title),'</p></div></a></li>')
                }
            ...
            var pager = new Pagination({
                ...
                callback:function(data){
                    ...
                    function updateDOM(dom,paddingData){
                        ...
                        titleP.innerHTML = handleTitle(paddingData.title);
