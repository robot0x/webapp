...
(function(global, factory) {
	...
	function defaultPrefilter(elem, props, opts) {
		...
		if (isBox && elem.nodeType === 1) {
			...
			if (display === "none") {
				display = restoreDisplay || swap(elem, {
					"display": ""
				}, function() {
...
$(".login").hover(function() {
	// 如果未登录的话，hover之后就不要显示出来list
	if (true) {
		$(".person-state-list-container").remove();
	}
})
...
ToTop.prototype = {
	...
	bindEvent: function() {
		...
		$obj.hover(function() {
			$obj.css("background-position", "0 52px");
		}, function() {
...
new ToTop(document.getElementById("totop"));